...
- **內容**：加入 Firefox 無資料收集聲明與永久 add-on ID；新增固定排序與時間戳的確定性 ZIP／SHA-256 建置流程、英中日 README、隱私聲明、AMO 商店文案及 GitHub／AMO 發布操作說明。
- **關聯文件**：README, PRIVACY, 100, 220, 600, AMO_LISTING
- **操作人**：Codex
